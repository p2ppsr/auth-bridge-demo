...
export function AuthBridgeLogin({ className, style }: AuthBridgeLoginProps) {
  ...
  // Note: Google OAuth callback is handled centrally in AuthBridgeProvider
  // so it works even if this component isn't currently mounted (e.g. the
  // login modal was closed by the OAuth redirect).
