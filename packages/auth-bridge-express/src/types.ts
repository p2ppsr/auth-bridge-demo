...
export interface AuthBridgeOptions {
  ...
  /** Hex root key for a funding wallet. If set, newly created managed wallets are funded via BRC-29. */
  fundingWalletKey?: string
  /** Satoshis to send to each new managed wallet from the funding wallet (default: 5000) */
